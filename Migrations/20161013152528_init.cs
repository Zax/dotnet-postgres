        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    data_decesso = table.Column<DateTime>(type: "Date", nullable: true),
                    data_fine_assistenza = table.Column<DateTime>(type: "Date", nullable: true),
                    data_inizio_assistenza = table.Column<DateTime>(type: "Date", nullable: true),
                    data_nascita = table.Column<DateTime>(type: "Date", nullable: true),
                    data_riferimento = table.Column<DateTime>(type: "Date", nullable: true),
